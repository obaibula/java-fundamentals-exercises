...
public class CrazyLambdas {
    ...
    public static Supplier<Thread> runningThreadSupplier(Runnable runnable) {
        return () -> getAndStartThread(runnable);
    }
    ...
    public static Function<Runnable, Supplier<Thread>> runnableToThreadSupplierFunction() {
        return runnable -> () -> getAndStartThread(runnable);
    }

    private static Thread getAndStartThread(Runnable runnable) {
    ...
    public static <T, U extends Comparable<? super U>> Comparator<T> thenComparing(
        ...
        return (c1, c2) -> comparator.compare(c1, c2) != 0 ?
                comparator.compare(c1, c2) :
                Comparator.comparing(mapper).compare(c1, c2);
    }
